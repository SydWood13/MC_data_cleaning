...
plot1 <- plot + geom_histogram(aes(x = pRep), fill = colors[5]) +labs(title = "Distribution of Percentage of Mistakes Repeated" ) +xlab("Percent Repeated") + ylab("Frequency")

plot1

ggsave(plot1, file = "repDist.png", height = 8.2, width = 13.6)
